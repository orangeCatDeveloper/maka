...
const SETTINGS_PROJECTS_COPY_BY_LOCALE = {
  zh: {
    runtimeHost: {
      ...
      pairingRecoveryDescription: '修改 Host 前需要先处理未完成的配对。',
      resolvePairingRecovery: '处理配对恢复',
  ...
  en: {
    runtimeHost: {
      ...
      pairingRecoveryDescription: 'Resolve the unfinished pairing before changing Hosts.',
      resolvePairingRecovery: 'Resolve pairing recovery',
